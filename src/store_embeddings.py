...
def main():
    ...
    if args.keyword_file != None:
        ...
        store_keywords(args.keyword_file, args.out_dir)
    if args.paper_file != None:
        print(f"Parsing paper file {args.paper_file}")
        store_papers(args.paper_file, args.out_dir)

def store_papers(papers_filepath: str, out_dir: str):
    """
    Stores the paper embeddings and paper meta into pickle files

    Args:
        keywords_filepath: the path to a json file containing papers data
    ...
    paper_metadata_file = out_dir + "SB_filtered_paper_data.pickle"
...
def store_keywords(keywords_filepath: str, out_dir: str):
    """
    ...
    metadata_out_file = out_dir + "springer_keyword_data.pickle"
